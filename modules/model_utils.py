...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # folder of utils.py
csv_path = os.path.join(BASE_DIR, 'skills.csv')  # skills.csv inside modules folder
